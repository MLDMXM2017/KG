...
<!--&lt;!&ndash;                placeholder="请输入节点个数"&ndash;&gt;-->
<!--&lt;!&ndash;                v-model="nodeName"&ndash;&gt;-->
<!--&lt;!&ndash;                @keyup.enter.native="getDomainGraph"&ndash;&gt;-->
<!--&lt;!&ndash;            ></el-input>&ndash;&gt;-->
<!--          </div>-->
          <span>
            <span class="dibmr">
        ...
        <div class="fr">
          ...
          <a href="javascript:void(0)" @click="deleteDomain(this.domainId,this.domain)" class="svg-a-sm">
            <i class="el-icon-tickets">删除领域</i>
          </a>
          <a
            href="javascript:void(0)"
...
export default {
  ...
  methods: {
    ...
    requestFullScreen() {
      ...
      this.$refs.kg_builder.svg.attr("width", width);
        this.$refs.kg_builder.svg.attr("height", height);
